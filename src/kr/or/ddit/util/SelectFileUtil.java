...
public class SelectFileUtil {
	// option 변수에는 "SAVE" 또는 "OPEN"값이 지정된다.
	// option이 'SAVE'이면 '저장창'이 'OPEN'이면 '열기창'이 나타난k
	public static File showDialog(String option	) {
		// SWING의 파일 열기, 저장 창 연습
				...
				if("SAVE".equals(option)) {
					...
					System.out.println("showDialog(String option)의 option은 'SAVE' 또는 'OPEN'만 가능합니다." );
				}
